...
QList<QSharedPointer<QObject> > ConverterBase::convertList(const QVariant &variant) const {
    Q_UNUSED(variant) return QList<QSharedPointer<QObject> >();
}
QSharedPointer<QObject> ConverterBase::convertObject(const QVariant &variant) const {
    Q_UNUSED(variant) return QSharedPointer<QObject>();
}
QVariant ConverterBase::convertVariant(QSharedPointer<QObject> object) const {
    Q_UNUSED(object) return QVariant();
}
QVariant ConverterBase::convertVariantList(QList<QSharedPointer<QObject> > objects) const {
    Q_UNUSED(objects) return QVariant();
}
QString ConverterBase::className() const {
    return QString();
}
QString ConverterBase::convertToSqlStorableValue(const QVariant &variant) const {
    Q_UNUSED(variant) return QString();
}
QVariant ConverterBase::convertFromSqlStorableValue(const QString &value) const {
    Q_UNUSED(value) return QVariant();
}
